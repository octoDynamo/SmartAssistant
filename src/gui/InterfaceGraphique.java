        ...
        try {
            ...
            if (commande.toLowerCase().startsWith("planifie ")) {
                ...
                if (parts.length < 1 || parts[0].trim().isEmpty()) {
                    ...
                    statusLabel.setText("Erreur: Description d'événement manquante");
                    return;
                }
                ...
                try {
                    ...
                    statusLabel.setText("Erreur: Format de date invalide");
                    return;
                }
                ...
                if (parts.length < 1 || parts[0].trim().isEmpty()) {
                    ...
                    statusLabel.setText("Erreur: Description de tâche manquante.");
                    return;
                }
                ...
                if (desc.isEmpty()) {
                    ...
                    !commande.toLowerCase().equals("news")) {
