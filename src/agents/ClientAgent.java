    ...
    public void envoyerCommande(String commande) {
        ...
        try {
            if (cmdLower.startsWith("planifie ")) {
                ...
                // Envoie la commande brute à l'agentTaches
                ...
                gui.afficherReponse("Commande inconnue. Essayez : planifie <événement>:<date>, liste_evenements, supprime événement <nom>, ajoute <tâche description>, supprime <tâche>, liste, vider, meteo <ville>, recette <nom>, wiki <terme>");
